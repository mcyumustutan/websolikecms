       ...
       <div class="row g-4 position-relative z-10">
           <div class="swiper favSwiper-active">
               <div class="swiper-wrapper">
                   ...
                   @foreach ($projectsArray['projectFinished'] as $project)
       ...
       <div class="row">
           <div class="col-12 text-center">
               <div class="section-button d-inline-block">
                   <a href="{{config('app.url')}}/{{App::getLocale()}}/projeler/tamamlanan-projeler">
                       <div class="btn-primary-icon-sm">
                           <p class="pera">Tüm Tamamlanan Projeler</p>
